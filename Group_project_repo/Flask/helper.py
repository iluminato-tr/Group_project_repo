...
def plot_pca(data, column_name, SelPop_populations, filename="pca_plot.png"): # File name for saved plot image
    ...
    pca_path = 'C:/Users/isabelasihene/Downloads/Group_project_repo/Flask/static/images/' # CHANGE PATH TO YOUR PATH
...
def plot_adm(data1, column_name, SelPop_populations, filename="adm_plot.png"): # File name for saved adm plot
    ...
    # Show plot
    plt.tight_layout()
    adm_path= 'C:/Users/isabelasihene/Downloads/Group_project_repo/Flask/static/images/' # CHANGE PATH TO YOUR PATH
